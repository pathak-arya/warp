...
impl AISettings {
    ...
    pub fn is_any_ai_enabled(&self, app: &AppContext) -> bool {
        // Local fork: AI/agent features work without a Warp login. Harnesses
        // (Claude Code, ...) authenticate through their own CLIs, so we don't
        // gate on `is_anonymous_or_logged_out` here.
